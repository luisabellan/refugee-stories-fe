  ...
  const slides = items.map((item) => {
    return (
      ...
      >
        ...
        <CarouselCaption captionText={item.caption} captionHeader={item.caption} captionButton={item.button} />
        <ReadMoreButton class="readme-button"><span>Read More</span></ReadMoreButton>
